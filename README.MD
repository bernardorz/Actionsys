...
> ⚠️ Devido a um bug do eslint antes de inicializar o projeto você deve entrar em cada arquivo .ts e .tsx e digitar ctrl + s
> para o eslint não gerar nenhum erro ⚠️.
